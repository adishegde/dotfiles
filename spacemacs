...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(highlight-indent-guides wakatime-mode)
   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()
   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(evil-search-highlight-persist highlight-indentation)
...
you should place your code here."
  ...
  (setq magit-repository-directories '("~/Programming/Projects/"))
  (global-git-commit-mode t)

  ;; :q should quit the frame not sapcemacs itself
  ...
  ;; Increase delay for 'jk' bindings
